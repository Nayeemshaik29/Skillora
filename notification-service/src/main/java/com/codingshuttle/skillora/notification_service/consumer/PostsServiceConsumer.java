package com.codingshuttle.skillora.notification_service.consumer;


import com.codingshuttle.skillora.notification_service.clients.ConnectionsClient;
import com.codingshuttle.skillora.notification_service.dto.PersonDto;
import com.codingshuttle.skillora.notification_service.entity.Notification;
import com.codingshuttle.skillora.notification_service.repository.NotificationRepository;
...
public class PostsServiceConsumer {
    ...
    public void handlePostCreated(PostCreatedEvent postCreatedEvent){
        ...
        List<PersonDto> connections = connectionsClient.getFirstConnections(postCreatedEvent.getCraetorId());

        for(PersonDto connection : connections){
            sendNotification(connection.getUserId(), "Your connection"+postCreatedEvent.getCraetorId()
            +" a post, Check it out ");
